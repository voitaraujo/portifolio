...
>
	...
	>
		...
		<p
			class="
                my-3 h-full
                border-l-2 border-neutral-400 pl-5 pr-2 text-justify text-slate-500
                "
		>
		...
		<div
			class="
        mt-5 flex
        flex-wrap rounded-md border-2 border-solid
        border-zinc-200 pb-2 pr-2 pl-2
        sm:mt-auto
        "
		>
			{#each experience.tecnologies as tec}
				<span
					class="ml-2 flex w-auto cursor-default items-center pt-2
            "
				>
